...
class ProductsTable:
    ...
    def insert(product_data):
        ...
        try:
            ...
            """
            data = [
                product_data["category_id"], product_data["product_code"], 
                product_data["product_name"], product_data["price"]
            ]
    ...
    def update(product_id, product_data):
        ...
        """ 
        try:
            valid, message = ProductsTable.validate_data_for_update(product_id, product_data)
            if not valid:
                return False, message, None
    ...
    def validate_updated_code(code, product_id):
        ...
        if (tmp_product is not None
            and tmp_product["ProductID"] is not int(product_id)
        ):
            return False, "Product code exists already."
    ...
    def validate_name(name):
        ...
        if len(name) == 0:
            ...
            return False, "Product name must have at least three characters."
